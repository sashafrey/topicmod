...
_REGULARIZERCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dictionary_name', full_name='artm.RegularizerConfig.dictionary_name', index=3,
...
_DIRICHLETPHICONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='beta', full_name='artm.DirichletPhiConfig.beta', index=0,
...
_SMOOTHSPARSEPHICONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='beta', full_name='artm.SmoothSparsePhiConfig.beta', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='background_beta', full_name='artm.SmoothSparsePhiConfig.background_beta', index=2,
...
_DIRICHLETPHICONFIG.fields_by_name['beta'].message_type = _DOUBLEARRAY
_SMOOTHSPARSETHETACONFIG.fields_by_name['alpha'].message_type = _DOUBLEARRAY
_SMOOTHSPARSEPHICONFIG.fields_by_name['beta'].message_type = _DOUBLEARRAY
_SMOOTHSPARSEPHICONFIG.fields_by_name['background_beta'].message_type = _DOUBLEARRAY
