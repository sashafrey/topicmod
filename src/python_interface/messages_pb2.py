...
_REGULARIZEROUTPUT = _descriptor.Descriptor(
  name='RegularizerOutput',
  full_name='artm.RegularizerOutput',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='output', full_name='artm.RegularizerOutput.output', index=0,
...
DESCRIPTOR.message_types_by_name['RegularizerOutput'] = _REGULARIZEROUTPUT
...
class RegularizerOutput(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _REGULARIZEROUTPUT
