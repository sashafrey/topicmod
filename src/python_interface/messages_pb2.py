...
_COLLECTIONPARSERCONFIG_FORMAT = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='BagOfWordsUci', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='JustLoadDictionary', index=1, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_BATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='class_id', full_name='artm.Batch.class_id', index=2,
...
_TOPICMODEL_TOPICMODELINTERNALS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='n_t_class_id', full_name='artm.TopicModel.TopicModelInternals.n_t_class_id', index=3,
      number=4, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
