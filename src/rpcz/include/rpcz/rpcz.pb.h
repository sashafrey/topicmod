...
enum rpc_response_header_application_error_code {
  rpc_response_header_application_error_code_RPCZ_NO_ERROR = 0,
...
const rpc_response_header_application_error_code rpc_response_header_application_error_code_application_error_code_MAX = rpc_response_header_application_error_code_RPCZ_NO_ERROR;
...
class rpc_response_header : public ::google::protobuf::Message {
 public:
  ...
  static const application_error_code RPCZ_NO_ERROR = rpc_response_header_application_error_code_RPCZ_NO_ERROR;
