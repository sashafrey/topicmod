...
_REGULARIZERCONFIG_TYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='DirichletRegularizerTheta', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DirichletRegularizerPhi', index=1, number=2,
      options=None,
      type=None),
  ],
  containing_type=None,
